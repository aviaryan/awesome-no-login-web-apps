...
* [ScreenCap Studio](https://screencap-studio.surge.sh/) - Annotate screenshots with arrows, boxes, text, numbered steps, and blur. Export as PNG. Works offline. ([Source](https://github.com/godfengliang/screencap-studio))
