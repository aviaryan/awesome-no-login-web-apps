...
* [ToolPipe](https://toolpipe.dev) - 220+ free developer utility tools and REST APIs: JSON formatter, QR code generator, hash generator, UUID, base64, regex tester, JWT decoder, DNS lookup, SSL checker, WHOIS, and more.
