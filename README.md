...
* [FastUtil](https://fastutil.app/) - 71+ free browser-based utilities (JSON formatter, Base64 encoder, hash generator, image converter, regex tester, etc.) with client-side processing and 20 language translations.
