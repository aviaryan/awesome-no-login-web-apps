...
* [MyGuy Tools](https://myguy.tools) - Collection of free browser-based utilities for images, PDFs, text, developer workflows and calculators; core features work without signup and many tools process files locally in the browser.
