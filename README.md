...
* [LPUBenchmark](https://pikadexofc.github.io/revforge-tools/tools/lpu-benchmark.html) - Real-time client-side latency, tokens/sec throughput, and TTFT testing engine for free-tier LPU compute endpoints without accounts or telemetry.
* [PromptPruner](https://pikadexofc.github.io/revforge-tools/tools/prompt-pruner.html) - Client-side AI prompt compressor and token cost simulator that cuts AI prompt token bloat by 30-45% entirely in browser without login or tracking.
