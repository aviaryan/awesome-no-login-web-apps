...
* [Filuni](https://www.filuni.com/) - 120+ free file tools in the browser: PDF merge/split/compress/convert, image, video and audio converters, and developer utilities. No signup and no upload limits. Most image and text tools run fully client-side; server-processed files are auto-deleted. Available in 11 languages.
