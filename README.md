...
* [Drag Task](https://drag-task.web.app/demo) - A calendar-shaped to-do list where tasks can be dragged between days. The demo works without login but resets when the tab closes; sign-in is required to save or sync tasks.
