...
* [GotConvert](https://gotconvert.com/) - 41 file converters (image, PDF, document, audio, video) plus passport-photo maker, background removal and image upscaling, all running locally in your browser so files are never uploaded. No account or quota; ad-supported and very large files are limited by browser memory.
