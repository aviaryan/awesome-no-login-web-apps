...
* [cv.cm](https://cv.cm/) - Browser-local PDF, image, and QR tools (files never leave the device) plus a no-login clipboard that shares text or files with an ultra-short link.
