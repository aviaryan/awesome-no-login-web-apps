...
* [TinyTools](https://tinytools-smoky.vercel.app/) - Free browser-based design utilities: color palette generator, favicon generator, OG image generator, and AI background remover (runs locally, no upload). No signup required. Open source.
