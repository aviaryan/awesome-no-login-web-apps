...
* [ConvertiZen](https://convertizen.netlify.app) - Document converter (PDF, Word, Excel, images) that works entirely in your browser. No file uploads — all conversions happen locally via WebAssembly.
